...
def get_monthly_habit_progress(user_id, habit_id, start_day, end_day, pagination=0):
    """
    ...
    # Creating a list of months for the reporting period
    ...
    month_periods = get_month_periods(first_day_of_month, last_day_of_month)
